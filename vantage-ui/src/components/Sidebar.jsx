...
import {
    ...
    LayoutDashboard, Zap, Target, Database, Activity, LogOut, Monitor
} from 'lucide-react';
    ...
    return (
        <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
            ...
            <nav className="sidebar-nav">
                ...
                <NavLink
                    to="/dashboard"
                    className={({ isActive }) => `nav-item ${(isActive || activeTabUrl === '/dashboard') && activeTabUrl !== '/monitoring' ? 'active' : ''}`}
                ...
                {/* Monitoring Link */}
                <div
                    className={`nav-item ${activeTabUrl === '/monitoring' ? 'active' : ''}`}
                ...
                >
                    <div className="nav-item-content">
                        <Monitor size={18} style={{ color: activeTabUrl === '/monitoring' ? '#10b981' : 'rgba(255, 255, 255, 0.5)' }} />
                        {!isCollapsed && <span>Monitoring</span>}
                    </div>
                    <div className="active-glow" style={{ background: '#10b981' }}></div>
                </div>
            </nav>
